...
const HomeScreen = () => {
  ...
  const FloatingElements = () => (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <div
        className={`absolute top-1/4 left-1/4 w-72 h-72 ${darkMode ? 'bg-gradient-to-r from-blue-400/5 to-purple-600/5' : 'bg-gradient-to-r from-blue-400/10 to-purple-600/10'} rounded-full blur-3xl animate-pulse`}></div>
      <div
  ...
  return (
    <div
          ...
          <div className="mb-8">
            <div className="relative mb-8">
              ...
              <div className="absolute bottom-12 left-1/3 transform -translate-x-12">
                <Rocket className="w-7 h-7 text-red-400 animate-bounce" style={{animationDelay: '2s'}}/>
              </div>
            </div>
      ...
      <section id="about" className="py-24 relative overflow-hidden">
        <div
          className={`absolute inset-0 ${darkMode ? 'bg-gradient-to-br from-blue-950/10 via-purple-950/10 to-pink-950/10' : 'bg-gradient-to-br from-blue-50/50 via-purple-50/30 to-pink-50/50'}`}></div>
      ...
      <section id="skills" className="py-24 relative">
        <div
          className={`absolute inset-0 ${darkMode ? 'bg-gradient-to-br from-gray-900 via-blue-950 to-purple-950' : 'bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50'}`}></div>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <h2
              className={`text-4xl sm:text-5xl font-bold mb-6 bg-gradient-to-r ${darkMode ? 'from-white via-blue-100 to-purple-100' : 'from-gray-900 via-blue-900 to-purple-900'} bg-clip-text text-transparent`}>
      ...
      <section id="projects" className="py-24 relative overflow-hidden">
        <div
          className={`absolute inset-0 ${darkMode ? 'bg-gradient-to-br from-purple-950/10 via-pink-950/10 to-orange-950/10' : 'bg-gradient-to-br from-purple-50/50 via-pink-50/30 to-orange-50/50'}`}></div>
        <FloatingElements/>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <h2
              ...
              <div key={index} className="group relative">
                ...
                <div
                  ...
                  <div className="p-8">
                    ...
                    <p
                      className={`${darkMode ? 'text-gray-300' : 'text-gray-600'} mb-6 leading-relaxed`}>{project.description}</p>

                    <div className="mb-6">
                      <h4
                        className={`font-semibold mb-3 ${darkMode ? 'text-gray-200' : 'text-gray-800'}`}>Technologies:</h4>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div className="mb-6">
                      <h4 className={`font-semibold mb-3 ${darkMode ? 'text-gray-200' : 'text-gray-800'}`}>Key
                        Features:</h4>
                      <ul className={`${darkMode ? 'text-gray-300' : 'text-gray-600'} text-sm space-y-1`}>
      ...
      <section id="experience" className="py-24 relative">
        <div
          className={`absolute inset-0 ${darkMode ? 'bg-gradient-to-br from-blue-950 via-cyan-950 to-teal-950' : 'bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50'}`}></div>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <h2
      ...
      <section id="contact" className="py-24 relative overflow-hidden">
        <div
          className={`absolute inset-0 ${darkMode ? 'bg-gradient-to-br from-pink-950/10 via-purple-950/10 to-blue-950/10' : 'bg-gradient-to-br from-pink-50/50 via-purple-50/30 to-blue-50/50'}`}></div>
        <FloatingElements/>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <h2
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className={`${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Connect with me</p>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className={`${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Check out my code</p>
                    </div>
                  </a>
                  ...
                  <div
                    ...
                    <div>
                      ...
                      <p className={`${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Available Remotely <span
      ...
      <footer className="py-12 relative overflow-hidden">
        <div
          className={`absolute inset-0 ${darkMode ? 'bg-gradient-to-r from-gray-950 via-purple-950 to-pink-950' : 'bg-gradient-to-r from-gray-900 via-purple-900 to-pink-900'}`}></div>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
